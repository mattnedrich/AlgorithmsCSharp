...
namespace AlgorithmsTests.Sorting
{
    ...
    public class MergesorterTests
    {
        ...
        public void Test_Sort_With_Null_Input_Throws_ArgumentException()
        {
            ...
            new Mergesorter<int>().Sort(nullList);
        }
        ...
        public void Two_Element_Input_Is_Sorted_Correctly()
        {
            ...
            List<int> result = new Mergesorter<int>().Sort(input).ToList();
            Assert.That(IsSorted(result));
        }
        ...
        {
            List<int> results = new Mergesorter<int>().Sort(input).ToList();
            Assert.That(IsSorted(results));
        }
